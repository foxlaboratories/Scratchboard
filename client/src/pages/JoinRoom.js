...
const JoinRoom  = (props) => {
    ...
    const onClick = () => {
        ...
        props.join(state.code, state.name);
    }
    ...
    return <Container component="main" maxWidth="xl" className={classes.root}>
        <Grid container spacing={3} className={classes.action}>
            ...
            <Grid item xs={12}>
                <TextField label="Room Code" required fullWidth variant="outlined" onChange={onChangeCode} />
            </Grid>
            <Grid item xs={12}>
                <Button variant="contained" color="primary" onClick={onClick}>Join Room</Button>
            </Grid>
        </Grid>
    </Container>
